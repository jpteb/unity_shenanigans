 ...
 */
#define UNITY_OUTPUT_CHAR(a)                    CustomOutputChar((a))
#define UNITY_OUTPUT_CHAR_HEADER_DECLARATION    CustomOutputChar(int)
#define UNITY_OUTPUT_FLUSH()                    CustomOutputFlush()
#define UNITY_OUTPUT_FLUSH_HEADER_DECLARATION   CustomOutputFlush(void)
#define UNITY_OUTPUT_START()                    CustomOutputStart()
#define UNITY_OUTPUT_COMPLETE()                 CustomOutputComplete()
